    ...
    return (
        <>
            {data
                ...
                : <div className="grid md:grid-cols-3 grid-cols-2 lg:gap-6 gap-4">
                    {[...Array(6)].map((_, i) => {
                        return <div key={i} dir='ltr' className={`relative select-none overflow-hidden flex flex-col items-stretch sm:gap-3 gap-4 sm:max-w-[302px] w-full h-fit flex-shrink-0 rounded-lg md:p-6 p-4 bg-white`}>
