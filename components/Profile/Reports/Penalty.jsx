...
const Penalty = () => {
    ...
    const [data, , , paginations, , loading] = useGetRequest(true,`/wallet/transactions?type=penalty`, currentPage, filters)
                        ...
                        <AccordionItem
                            ...
                            title={
                                <div className="grid grid-cols-3 gap-2 text-xs">
                                    ...
                                    <span className="col-span-2 text-black font-semibold">{item.description}</span>
                                </div>
                            }>
