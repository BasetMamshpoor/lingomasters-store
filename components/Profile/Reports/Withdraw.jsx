...
import {
    ...
    AccordionItem,
    Button,
    Chip, Input, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Spinner,
    Table,
    TableBody, TableCell,
    TableColumn,
    TableHeader,
...
const Withdraw = () => {
    ...
    const [data, , , paginations, , loading] = useGetRequest(true, `/wallet/transactions?type=withdraw`, currentPage, filters)
            ...
            <div className="flex flex-col gap-8">
                ...
                >
                    <TableHeader>
                        ...
                        <TableColumn>به حساب</TableColumn>
                        <TableColumn>نام صاحب حساب</TableColumn>
                    ...
                    <TableBody
                        ...
                        {data?.map(item => (
                            <TableRow key="1">
                                ...
                                <TableCell>{item.account_owner_name} </TableCell>
                ...
                <Accordion
                    ...
                    {data?.map(item => (
                        <AccordionItem
                            key={item.id}
                            textValue={item.account_owner_name}
                            title={
                                <div className="grid grid-cols-3 gap-2 text-xs">
                                    <span className="text-natural_gray-950">نام صاحب حساب</span>
                                    <span
                                        className="col-span-2 text-black font-semibold">{item.account_owner_name}</span>
                                </div>
                            }>
                            ...
                            <p className="text-natural_gray-950">به حساب</p>
                            <p className="col-span-2 font-semibold">{item.accent_number}</p>
