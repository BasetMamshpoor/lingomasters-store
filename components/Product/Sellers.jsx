                ...
                <ul className="flex flex-col gap-8">
                    {[...Array(8)].map((_, i) => {
                        return <li className='flex items-center justify-between gap-1' key={i}>
                            <span className='text-primary-950'>سعید اسدی</span>
                            <span className='text-natural_gray-950'>ارسال امروز</span>
                            <span className='text-green-600'>{formatCurrency(2000000)} تومان</span>
