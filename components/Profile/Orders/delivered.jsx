    ...
    return (
        <>
            <div dir="rtl" className="flex flex-col p-6 gap-6 bg-white border border-natural_gray-200 rounded-xl">
                <div className="flex justify-between pb-6 border-b border-gray-200 w-full lg:gap-4">
                    <div className="flex flex-col gap-2 w-full">
                        ...
                        <div className="grid grid-rows-4 md:grid-cols-2 lg:flex justify-between items-center flex-wrap flex-grow gap-4">
