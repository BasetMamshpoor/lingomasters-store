...
const Video = () => {
    return (
        <>
            <div className="p-6 flex flex-col gap-6 bg-white rounded-lg border-natural_gray-100 border scroll-m-2" id='video'>
                <div className="centerOfParent gap-2 w-fit">
                    <div className="centerOfParent"><Media className='w-5 h-5' /></div>
                    <span className='text-primary-950'>ویدیو کتاب</span>
                </div>
