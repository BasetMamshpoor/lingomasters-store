                    ...
                    <div className="flex flex-col gap-8 w-full">
                        <div className="flex flex-col gap-4 w-full">
                            <div className="flex w-full justify-between ">
                                ...
                                <Like id={id} isLike={is_like} url='/workshop-reserve'/>
                            </div>
                            <div className="flex flex-col gap-2 items-center">
                                ...
                                <div className="flex items-center gap-4 w-full">
                                    <div
                                        className="flex items-center gap-4 p-2 flex-1 whitespace-nowrap bg-primary-50 rounded-md">
                                        <p className="text-natural_gray-700 text-xs">شهر</p>
                                        <p className="text-sm">{city}</p>
                                    </div>
                                    <div
                                        className="flex items-center gap-4 p-2 flex-1 whitespace-nowrap bg-primary-50 rounded-md">
                                        <p className="text-natural_gray-700 text-xs">کشور</p>
                                ...
                                <div
                                    className="flex items-center justify-center gap-4 p-2 flex-1 w-full whitespace-nowrap bg-primary-50 rounded-md">
