            ...
            {isLoading ?
                ...
                <div dir="rtl" className="flex flex-col p-6 gap-6 bg-white border border-natural_gray-200 rounded-xl">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        {data.returned_date && <div className="flex items-center justify-between">
                            <p className="text-xs text-natural_gray-900">تاریخ مرجوعی:</p>
                            <p className="text-xs md:text-sm">{new Date(data.returned_date).toLocaleString(`fa-Ir`, {
                                year: 'numeric',
                                month: 'long',
                                day: 'numeric',
                            })}</p>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <p className="text-xs md:text-sm">{data.returned_reason}</p>
                        </div>
                    </div>
                </div>}
        </>
